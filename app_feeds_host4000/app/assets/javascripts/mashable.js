var Mashable = function(container, data){
  'use strict';
...
Mashable.prototype.init = function(data) {
  'use strict';  
  console.log(data[0]);
...
Mashable.prototype.draw = function() {
...
Mashable.prototype.getData = function() {
  var self = this;
  $.ajax({
    type: 'get',
...
Mashable.prototype.appendSection = function() {
  if (this.container) {
